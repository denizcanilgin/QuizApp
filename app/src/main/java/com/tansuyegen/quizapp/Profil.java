package com.tansuyegen.quizapp.MenuAct;
    ...
    private void setUserProfilUrl(Uri uri){
        ...
        user.updateProfile(request).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(Profil.this,"Başarıyla yüklendi",Toast.LENGTH_LONG).show();

            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Profil.this,"Resim Yüklenemedi.Tekrar Deneyiniz.",Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        user.updatePassword(newPass)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful())
                    Toast.makeText(Profil.this, "Güncellendi", Toast.LENGTH_SHORT).show();
            }
        });
        DocumentReference userRef = db.collection("Users").document(FirebaseAuth.getInstance().getUid());
            ...
            userRef
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Intent intent=new Intent(Profil.this, AuthActivity.class);
